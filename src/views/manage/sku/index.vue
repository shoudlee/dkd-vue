<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <!--  导入按钮-->
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Upload" @click="handleExcelImport"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除商品编号为"' + _skuIds + '"的数据项？').then(function () {
...
function getSkuClassList() {
  listSkuClass(loadAllParams).then(response => { skuClassList.value = response.rows });
}
